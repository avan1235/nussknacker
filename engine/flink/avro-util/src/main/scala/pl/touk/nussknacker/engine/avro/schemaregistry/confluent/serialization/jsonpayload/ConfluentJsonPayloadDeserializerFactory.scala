...
class ConfluentKeyValueKafkaJsonDeserializerFactory(schemaRegistryClientFactory: ConfluentSchemaRegistryClientFactory, useStringAsKey: Boolean)
  extends KafkaAvroKeyValueDeserializationSchemaFactory(useStringAsKey) with ConfluentJsonPayloadDeserializer {
