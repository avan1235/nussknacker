...
class KafkaAvroSourceFactorySpec extends KafkaAvroSpecMixin with KafkaAvroSourceSpecMixin {
  ...
  test("should read generated record in v1") {
    ...
    roundTripValueObject(avroSourceFactory(useStringAsKey = true), RecordTopic, ExistingSchemaVersion(1), "", givenObj)
  }

  test("should read generated record in v2") {
    val givenObj = FullNameV2.createRecord("Jan", "Maria", "Kowalski")

    roundTripValueObject(avroSourceFactory(useStringAsKey = true), RecordTopic, ExistingSchemaVersion(2), "", givenObj)
  }

  test("should read generated record in last version") {
    val givenObj = FullNameV2.createRecord("Jan", "Maria", "Kowalski")

    roundTripValueObject(avroSourceFactory(useStringAsKey = true), RecordTopic, LatestSchemaVersion, "", givenObj)
  }

  test("should return validation errors when schema doesn't exist") {
    val givenObj = FullNameV2.createRecord("Jan", "Maria", "Kowalski")

    readLastMessageAndVerify(avroSourceFactory(useStringAsKey = true), "fake-topic", ExistingSchemaVersion(1), "", givenObj) should matchPattern {
  ...
  test("should return validation errors when schema version doesn't exist") {
    ...
    readLastMessageAndVerify(avroSourceFactory(useStringAsKey = true), RecordTopic, ExistingSchemaVersion(3), "", givenObj) should matchPattern {
  ...
  test("should read last generated simple object without key schema") {
    ...
    roundTripValueObject(avroSourceFactory(useStringAsKey = true), IntTopicNoKey, ExistingSchemaVersion(1), "", givenObj)
  }

  test("should ignore key schema and empty key value with string-as-key deserialization") {
    val givenObj = 123123

    roundTripValueObject(avroSourceFactory(useStringAsKey = true), IntTopicWithKey, ExistingSchemaVersion(1), "", givenObj)
  }
  ...
  test("should read last generated simple object with expected key schema and valid key") {
    ...
    readLastMessageAndVerify(avroSourceFactory(useStringAsKey = true), IntTopicWithKey, ExistingSchemaVersion(1), new String(serializedKey, StandardCharsets.UTF_8), givenObj)
  }
  ...
  test("should read object with invalid defaults") {
    ...
    roundTripValueObject(avroSourceFactory(useStringAsKey = true), InvalidDefaultsTopic, ExistingSchemaVersion(1), "", givenObj)
  }
  ...
  test("should read last generated key-value object, simple type") {
    ...
    roundTripKeyValueObject(avroSourceFactory(useStringAsKey = false), IntTopicWithKey, ExistingSchemaVersion(1), givenKey, givenValue)
  }
  ...
  test("should read last generated key-value object, complex object") {
    ...
    roundTripKeyValueObject(avroSourceFactory(useStringAsKey = false), RecordTopicWithKey, ExistingSchemaVersion(1), givenKey, givenValue)
  }
  ...
  private def validate(params: (String, Expression)*): TransformationResult = {
    ...
    validator.validateNode(avroSourceFactory(useStringAsKey = true), paramsList, Nil, Some(VariableConstants.InputVariableName))(ValidationContext()).toOption.get
  }
